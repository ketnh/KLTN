...
class Tinhtrangthuly
{
     ...
     *
     * @param \Acme\KLBundle\Entity\Chuyenvienthuly $idchuyenvienthuly
     * @return Tinhtrangthuly
     */
    public function setIdchuyenvienthuly(\Acme\KLBundle\Entity\Chuyenvienthuly $idchuyenvienthuly = null)
    {
